    ...
    <div className="bg-[#0F111A] text-white min-h-screen pt-32 pb-20">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-4 mb-8 text-[#EF4444]">
            <HeartPulse size={32} />
            <h1 className="space-grotesk text-4xl md:text-6xl font-bold">
              {t("academy.healthSafety.title")}
            </h1>
          </div>
          <h2 className="space-grotesk text-2xl md:text-3xl font-bold mb-8 text-white/90">
            {t("academy.healthSafety.subtitle")}
          </h2>
          <p className="text-[#A1A1A6] text-xl leading-relaxed mb-12 font-inter">
            {t("academy.healthSafety.description")}
          </p>
          <Link
            href={`/${lang}/signup`}
            className="inline-flex items-center gap-3 bg-[#EF4444] text-white font-bold px-10 py-5 rounded-2xl hover:scale-105 transition-transform"
